...
from app.api.internal import ai_config, knowledge, card_order, knowledge_search, metrics_endpoints, settings, webhooks, automations, broadcasts, whatsapp, flows
...
router.include_router(card_order.router)
...
router.include_router(flows.router) # Moved to correct position
