            ...
            <div>
              <form onSubmit={handleScheduleActivity} className="mb-6 space-y-3">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm text-slate-800 outline-none focus:border-indigo-600 focus:ring-1 focus:ring-indigo-600"
                />
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 rounded-lg border border-slate-200 px-3 py-2 text-sm text-slate-800 outline-none focus:border-indigo-600 focus:ring-1 focus:ring-indigo-600"
                  />
                  <button
                    type="submit"
                  ...
                  {customFieldRows.map((row, index) => (
                    <div key={index} className="flex gap-2">
                      <input
                        ...
                        className="w-1/2 rounded-lg border border-slate-200 px-2 py-1.5 text-sm text-slate-800 outline-none focus:border-indigo-600 focus:ring-1 focus:ring-indigo-600"
                      />
                      <input
                        type="text"
                        placeholder="Valor"
