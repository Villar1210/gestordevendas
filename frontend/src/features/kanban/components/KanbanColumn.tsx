    ...
    >
      ...
      <div className="border-t border-slate-200 p-2">
        <button
          ...
          className="flex w-full items-center justify-center gap-1.5 rounded-lg py-2 text-sm font-medium text-slate-500 transition hover:bg-slate-50 hover:text-indigo-600"
        >
