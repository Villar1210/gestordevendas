...
// proposito, nao ha estado nenhum compartilhado com outra tela.
    ...
    <div className="min-h-screen bg-slate-50">
      <header className="border-b border-slate-200 bg-white px-6 py-4">
        ...
        <p className="mt-0.5 text-sm text-slate-500">
          Dados da empresa - usados para preencher contratos gerados automaticamente (ex: contrato de
          prestação de serviço de corretores/parceiros).
        </p>
      </header>
      ...
      <div className="p-6">
        {isLoading ? (
          ...
          <div className="max-w-2xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <h2 className="mb-4 text-sm font-semibold text-slate-800">Dados da Empresa</h2>
